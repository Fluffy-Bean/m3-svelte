<script lang="ts">
    ...
    let { style, icon_orientation, text, icon, onclick = () => {} }: Props = $props();
    let styles = {
...
<button
    class="flex justify-center items-center gap-4 h-10 px-6 rounded-full shadow-m3-shadow focus:outline-none {styles[style]}"
